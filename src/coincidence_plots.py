...
plt.plot(ra_vertices_22, de_vertices_22,
         color = 'tab:blue', linestyle = '--',
         label = 'IC220424A\nGCN Circular', linewidth = 3)
plt.plot(ra_vertices_23, de_vertices_23,
         color = 'tab:orange', linestyle = '--',
         label = 'IC230416A\nGCN Circular', linewidth = 3)
plt.plot(CIRCULAR_22_COORDS[RA_INDEX], CIRCULAR_22_COORDS[DE_INDEX],
         marker = 'o', color = 'tab:blue')
plt.plot(CIRCULAR_23_COORDS[RA_INDEX], CIRCULAR_23_COORDS[DE_INDEX],
         color = 'tab:orange', marker='o')
plt.plot(NGC7469_COORDS[RA_INDEX], NGC7469_COORDS[DE_INDEX],
         marker = '*', markeredgecolor = 'black', color = 'yellow',
         markersize = 20, label = 'NGC 7469', linestyle = '',
         markeredgewidth=1.5)
...
plt.plot(ras_err_22, des_err_22,
         color = 'tab:blue', linestyle = '--',
         label = 'IC220424A\nGCN Notice', linewidth = 3)
plt.plot(ras_err_23, des_err_23,
         color = 'tab:orange', linestyle = '--',
         label = 'IC230416A\nGCN Notice', linewidth = 3)
plt.plot(NOTICE_22_COORDS[RA_INDEX], NOTICE_22_COORDS[DE_INDEX],
         marker = 'o', color = 'tab:blue')
plt.plot(NOTICE_23_COORDS[RA_INDEX], NOTICE_23_COORDS[DE_INDEX],
         color = 'tab:orange', marker='o')
plt.plot(NGC7469_COORDS[RA_INDEX], NGC7469_COORDS[DE_INDEX],
         marker = '*', markeredgecolor = 'black', color = 'yellow',
         markersize = 20, label = 'NGC 7469', linestyle = '',
