...
print("Plotting GCN Circulars and GCN Notices together...")
...
plt.xlim(344.5, 348)
plt.ylim(7.8, 11.5)
plt.title("Circulars' and Notices' 90% contours", size="xx-large")
plt.legend(fontsize="large")
ax.set_xticks([345, 346, 347, 348])
ax.set_xticklabels([345, 346, 347, 348], size="x-large")
ax.set_yticklabels(ax.get_yticks(), size="x-large")

print("Saving GCN Circulars and GCN Notices plot...")

plt.savefig(figures_path / cfg.CIRCULAR_NOTICE_PLOT_FILENAME, bbox_inches="tight")
circular_notice_plot_filename_pdf = cfg.CIRCULAR_NOTICE_PLOT_FILENAME + ".pdf"
plt.savefig(figures_path / circular_notice_plot_filename_pdf, bbox_inches="tight")
plt.close()
